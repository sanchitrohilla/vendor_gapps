...
ifeq ($(TARGET_ARCH),arm64)
PRODUCT_COPY_FILES += \
    vendor/gapps/lib64/libarcore_c.so:system/lib64/libarcore_c.so \
    vendor/gapps/lib64/libdevice_profile_loader.so:system/lib64/libdevice_profile_loader.so
else
PRODUCT_COPY_FILES += \
    vendor/gapps/lib/libarcore_c.so:system/lib/libarcore_c.so \
    vendor/gapps/lib/libdevice_profile_loader.so:system/lib/libdevice_profile_loader.so
endif
...
PRODUCT_COPY_FILES += \
    ...
    vendor/gapps/etc/permissions/privapp-permissions-platform.xml:system/etc/permissions/privapp-permissions-platform.xml \
    vendor/gapps/etc/permissions/privapp-permissions-wahoo.xml:system/etc/permissions/privapp-permissions-wahoo.xml \
    vendor/gapps/etc/default-permissions/default-permissions.xml:system/etc/default-permissions/default-permissions.xml \
    vendor/gapps/etc/sysconfig/framework-sysconfig.xml:system/etc/sysconfig/framework-sysconfig.xml \
